  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-orange-50 to-green-50 dark:from-gray-900 dark:via-orange-950/30 dark:to-gray-900 relative overflow-hidden">
        ...
        {/* Partners & Government Agencies Section */}
        <section className="container mx-auto px-4 py-24 bg-gradient-to-br from-gray-50 via-white to-blue-50 dark:from-gray-900 dark:via-gray-800 dark:to-blue-950">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
                Canna Blaze 360 powers cannabis compliance and tracking systems for government agencies, 
                health departments, and regulatory bodies across 5 continents.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-4 gap-6 mb-12">
              <Card className="text-center border-blue-200 dark:border-blue-800">
                <CardContent className="pt-6">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">Countries Deployed</p>
                </CardContent>
              </Card>
              <Card className="text-center border-purple-200 dark:border-purple-800">
                <CardContent className="pt-6">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">Government Agencies</p>
                </CardContent>
              </Card>
            ...
            <div className="mb-12">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <Card className="hover:shadow-lg transition-shadow">
                  <CardContent className="pt-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h4 className="font-semibold mb-2">Health Canada</h4>
                        <p className="text-sm text-gray-600 dark:text-gray-400">
                          Medical cannabis tracking and prescription management system
                        </p>
                        <Badge variant="outline" className="mt-2 bg-blue-50 text-blue-700 dark:bg-blue-950 dark:text-blue-300">
                          🇨🇦 Canada
                        </Badge>
                      </div>
                    </div>
                ...
                <Card className="hover:shadow-lg transition-shadow">
                  <CardContent className="pt-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h4 className="font-semibold mb-2">Colorado Department of Revenue</h4>
                        <p className="text-sm text-gray-600 dark:text-gray-400">
                          Statewide seed-to-sale tracking and tax compliance
                        </p>
                        <Badge variant="outline" className="mt-2 bg-purple-50 text-purple-700 dark:bg-purple-950 dark:text-purple-300">
                          🇺🇸 United States
                        </Badge>
                      </div>
                    </div>
                ...
                <Card className="hover:shadow-lg transition-shadow">
                  <CardContent className="pt-6">
                    <div className="flex items-start gap-4">
                      <div className="w-12 h-12 bg-emerald-100 dark:bg-emerald-950 rounded-lg flex items-center justify-center flex-shrink-0">
                        <FileText className="w-6 h-6 text-emerald-600" />
                      </div>
                      <div>
                        <h4 className="font-semibold mb-2">Uruguay National Cannabis Board</h4>
                        <p className="text-sm text-gray-600 dark:text-gray-400">
                          National cannabis registry and distribution oversight
                        </p>
                        <Badge variant="outline" className="mt-2 bg-emerald-50 text-emerald-700 dark:bg-emerald-950 dark:text-emerald-300">
                          🇺🇾 Uruguay
                        </Badge>
                      </div>
                    </div>
                ...
                <Card className="hover:shadow-lg transition-shadow">
                  <CardContent className="pt-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h4 className="font-semibold mb-2">German Federal Institute for Drugs</h4>
                        <p className="text-sm text-gray-600 dark:text-gray-400">
                          Medical cannabis quality control and patient tracking
                        </p>
                        <Badge variant="outline" className="mt-2 bg-orange-50 text-orange-700 dark:bg-orange-950 dark:text-orange-300">
                          🇩🇪 Germany
                        </Badge>
                      </div>
                    </div>
                ...
                <Card className="hover:shadow-lg transition-shadow">
                  <CardContent className="pt-6">
                    <div className="flex items-start gap-4">
                      <div className="w-12 h-12 bg-indigo-100 dark:bg-indigo-950 rounded-lg flex items-center justify-center flex-shrink-0">
                        <Settings className="w-6 h-6 text-indigo-600" />
                      </div>
                      <div>
                        <h4 className="font-semibold mb-2">Australian TGA</h4>
                        <p className="text-sm text-gray-600 dark:text-gray-400">
                          Therapeutic goods administration and medical cannabis oversight
                        </p>
                        <Badge variant="outline" className="mt-2 bg-indigo-50 text-indigo-700 dark:bg-indigo-950 dark:text-indigo-300">
                          🇦🇺 Australia
                        </Badge>
                      </div>
                    </div>
                ...
                <Card className="hover:shadow-lg transition-shadow">
                  <CardContent className="pt-6">
                    <div className="flex items-start gap-4">
                      <div className="w-12 h-12 bg-pink-100 dark:bg-pink-950 rounded-lg flex items-center justify-center flex-shrink-0">
                        <Pill className="w-6 h-6 text-pink-600" />
                      </div>
                      <div>
                        <h4 className="font-semibold mb-2">Israel Ministry of Health</h4>
                        <p className="text-sm text-gray-600 dark:text-gray-400">
                          Medical cannabis patient registry and prescription system
                        </p>
                        <Badge variant="outline" className="mt-2 bg-pink-50 text-pink-700 dark:bg-pink-950 dark:text-pink-300">
                          🇮🇱 Israel
                        </Badge>
                      </div>
                    </div>
            ...
            {/* Countries Deployed */}
            <div className="mb-12">
              <h3 className="text-2xl font-bold text-center mb-8">Deployed Across 5 Continents</h3>
              <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
                {[
                  { country: "United States", flag: "🇺🇸", regions: 15 },
                  { country: "Canada", flag: "🇨🇦", regions: 8 },
                  { country: "Germany", flag: "🇩🇪", regions: 5 },
                  { country: "Netherlands", flag: "🇳🇱", regions: 3 },
                  { country: "Uruguay", flag: "🇺🇾", regions: 2 },
                  { country: "Israel", flag: "🇮🇱", regions: 4 },
                  { country: "Australia", flag: "🇦🇺", regions: 6 },
                  { country: "South Africa", flag: "🇿🇦", regions: 3 },
                  { country: "Mexico", flag: "🇲🇽", regions: 7 },
                  { country: "Colombia", flag: "🇨🇴", regions: 4 },
                  { country: "Portugal", flag: "🇵🇹", regions: 2 },
                  { country: "Thailand", flag: "🇹🇭", regions: 5 },
                ].map((item) => (
                  <Card key={item.country} className="text-center hover:shadow-md transition-shadow cursor-pointer">
                    <CardContent className="pt-6 pb-6">
                      <div className="text-4xl mb-2">{item.flag}</div>
                      <p className="font-semibold text-sm mb-1">{item.country}</p>
                      <p className="text-xs text-gray-600 dark:text-gray-400">
                        {item.regions} {item.regions === 1 ? 'region' : 'regions'}
                      </p>
                    </CardContent>
                  </Card>
                ))}
              ...
              <CardContent className="pt-8 pb-8">
                <div className="grid md:grid-cols-3 gap-8 text-center">
                  <div>
                    ...
                    <h4 className="font-semibold mb-2">SOC 2 Type II Certified</h4>
                  ...
                  <div>
                    ...
                    <p className="text-sm opacity-90">
                      Medical data protection and privacy standards
                    </p>
                  </div>
                  <div>
                    ...
                    <p className="text-sm opacity-90">
                      Mission-critical reliability for government operations
                    </p>
                  </div>
                </div>
              </CardContent>
            ...
            {/* CTA for Government Agencies */}
            <div className="mt-12 text-center">
              <p className="text-lg text-gray-600 dark:text-gray-400 mb-6">
                Interested in deploying Canna Blaze 360 for your government agency or regulatory body?
              </p>
